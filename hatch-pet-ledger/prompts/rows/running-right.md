Create one horizontal animation strip for Codex pet `ledger`, state `running-right`.
...
Identity: same pet in every frame: A small non-animal desktop workflow sentinel mascot: rounded charcoal-and-teal body, warm amber face, tiny checklist-tab crest, subtle clock-and-check motif as abstract shapes only, calm focused expression, built for compact Codex pet readability, no text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: polished soft 3D toy mascot, compact silhouette, restrained charcoal teal amber palette, no readable symbols or letters.
