...
```powershell
dotnet run --project AiTaskTracker.Server\AiTaskTracker.Server.csproj
```
...
```text
AiTaskTracker.Server\App_Data\aitasktracker.db
```
...
```powershell
dotnet build AiTaskTracker.Server\AiTaskTracker.Server.csproj -c Release
dotnet .\AiTaskTracker.Server\bin\Release\net7.0\AiTaskTracker.Server.dll --urls http://127.0.0.1:5187
```
...
```text
AiTaskTracker.Server\appsettings.Supabase.example.json
```
...
```bash
dotnet publish AiTaskTracker.Server/AiTaskTracker.Server.csproj -c Release -o out
...
```powershell
dotnet run --project AiTaskTracker.Server\AiTaskTracker.Server.csproj --urls http://0.0.0.0:5187
```
...
1. Install .NET 7 SDK.
2. Run `dotnet build AiTaskTracker.Server\AiTaskTracker.Server.csproj`.
3. Start the API with `dotnet run --project AiTaskTracker.Server\AiTaskTracker.Server.csproj`.
